export declare const BODY_TYPES: readonly ["cbbe", "3ba", "coco", "himbo", "bodytalk", "tbd", "sos", "unp", "bhunp", "uunp", "ube", "7base", "sam", "vanilla"];
...
export type EngineQualityGate = {
    id: "partition-integrity" | "bone-coverage" | "weight-normalization" | "morph-validity" | "tri-compatibility" | "physics-markers";
...
export type ConversionPhysicsProfile = "auto" | "dual" | "cbpc" | "hdt-smp" | "softbody" | "none";
...
export type ConversionJobEvent = {
    jobId: string;
    type: "status";
    stage: "queued" | "scan" | "python-engine" | "conversion" | "reports" | "done";
    message: string;
    progress: number;
} | {
    jobId: string;
